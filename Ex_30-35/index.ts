//--------------------------------------EX-30----------------------------------------------------//
const userNames: string[] = ["Admin", "Ali", "Ahmed", "Yasir", "Umar"];
...
//--------------------------------------EX-32----------------------------------------------------//
const current_users: string[] = ["Ali23", "Saleem68", "Ali12", "Yasir78", "Usman11"];
const new_users: string[] = ["Ali23", "Jawad7", "Yasir78", "Hassan65" , "Kashif44"];
...
//--------------------------------------EX-34----------------------------------------------------//
const fav_pizzas: string[] = ["Cheesy garlic", "Crown crust", "BBQ chicken"];
